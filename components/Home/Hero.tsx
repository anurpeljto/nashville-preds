...
const Hero = () => {
  return (
    <section id='home' className='relative mx-auto md:w-2/3 lg:px-20 md:px-10 sm:py-44 py-20 flex flex-row items-start justify-between sm:gap-12 px-5 overflow-hidden'>
